...
$tests = @(
  ...
  @{ Top = 'tb_rv64_fpu';    File = 'sim/tb_rv64_fpu.sv' },
  @{ Top = 'tb_rv64fd_core'; File = 'sim/tb_rv64fd_core.sv' },
  @{ Top = 'tb_rv64fd_trap'; File = 'sim/tb_rv64fd_trap.sv' },
  @{ Top = 'tb_rv64cd_decompressor'; File = 'sim/tb_rv64cd_decompressor.sv' },
